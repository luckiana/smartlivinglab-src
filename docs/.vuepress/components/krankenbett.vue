<template>
  <section id="krankenbett" class="krankenbett">
    <div class="container-fluid padding-size">
      <div class="row">
        <div class="col-md-7">
          <slot name="img">
          <img src="../public/assets/img/krankenbett.jpg" />
          </slot>
        </div>
        <div class="col-md-5 text-center">
          <slot name="title"><h3>Krankenbett</h3></slot>
          <slot name="text">
            <p>
...
img {
  height: 100%;
  width: 100%;
  box-shadow: 10px 10px 10px rgba(122, 122, 122, 0.5);
  border-radius: 10px;
}
.padding-size {
  padding-top: 2%;
